...
# URL et Clé Publique (safe pour le web)
...
# Récupération des médias (Logo et Vidéo)
...
with tab_client:
    if st.session_state.step == "upload":
        ...
        if f:
            ...
            # Analyse des pages (NB vs Couleur)
            doc = fitz.open(p_pdf)
            nb_c = 0
            for pg in doc:
